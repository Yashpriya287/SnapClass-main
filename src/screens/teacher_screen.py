...
def teacher_dashboard():
    ...
    st.subheader(f""" welcome back  {teacher_data['username']}""")
    ...
    with tab1:
         ...
         if st.button('Take Attendance',type=type1,width='stretch', icon=":material/add_reaction:"):
            st.session_state.current_teacher_tab='take_attendance'
            st.rerun()
    with tab2:
...
def teacher_tab_take_attendance():
    ...
    if not subjects:
        st.warning("You havent created any subject yet! ")
        return
    ...
    with c2:
        ...
        if st.button("Run Face Analysis ",width="stretch",type="secondary",icon=":material/analytics:",disabled= not has_photos):
            with st.spinner("Deep scanning classroom photos..."):
                ...
                attendance_result_dailog(pd.DataFrame(results),attendance_to_log)
    with c3:
...
def teacher_screen_login():
    ...
    st.space()
    teacher_username=st.text_input("Enter Username",placeholder="anayaroy")

    teacher_pass=st.text_input("Enter password", type='password',placeholder="enter password")
    st.divider()
    btnc1,btnc2=st.columns(2,gap="large", vertical_alignment="top")
    with btnc1:
...
def teacher_screen_register():   
    ...
    teacher_name=st.text_input("Enter name",placeholder="anaya roy")
    ...
    with btnc1:
         ...
         if st.button("Register Now",type="primary", icon=":material/passkey:",icon_position="left",shortcut="control+enter",width="stretch"):
    ...
    with btnc2:
        if st.button("Login Instead", icon=":material/passkey:",icon_position="left",width="stretch"):
            st.session_state.teacher_login_type='login'
